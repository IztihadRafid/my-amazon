...
const HomeBanner = () => {
  return (
    <div className="lg:mb-20 md:mb-10 mb-5 py-8  md:py-10  bg-shop_light_pink rounded-lg px-6 md:px-10 lg:px-20 flex items-center justify-between w-[70%] mx-auto">
      <div className="">
