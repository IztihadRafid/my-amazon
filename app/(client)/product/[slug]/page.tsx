...
const SingleProductPage = async ({
  ...
  const product = await getProductbySlug(slug); //Fetched product by slug
    ...
    <Container className="flex flex-col md:flex-row gap-10 py-10">
      ...
      <div className="w-full md:w-1/2  flex flex-col gap-5">
        ...
        <div className="space-y-2 border-t border-b border-gray-200 py-5 ">
          ...
          ></PriceView>
          <p
            className={`px-4 py-1.5 font-semibold text-sm text-center rounded-lg inline-block ${product?.stock === 0 ? "bg-red-100 text-red-600" : "bg-green-100 text-green-600"}`}
          >
